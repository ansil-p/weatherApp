...
export default function LoginForm() {
  ...
  return (
    <div className="grid place-items-center h-screen bg-gradient-to-tl from-pink-300 to-green-300">
      <div className="shadow-2xl p-4 rounded-lg border flex gap-4 bg-gray-100">

        <div className="px-4 py-9 max-lg:py-4 flex flex-col gap-4">
